    ...
    <div className="h-screen w-screen bg-white flex flex-col overflow-hidden">
      ...
      <div className="flex-grow flex flex-col text-center lg:mt-15 overflow-auto">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl text-[#6223b4] mt-10 font-semibold">
          Online <span className="bg-[#23cb6369] rounded-xl p-1">Canvas</span> For Your Imagination
        </h1>

        {/* Tagline */}
        <p className="text-[#280f48] mt-10 lg:text-lg font-semibold mb-25">
          Ideate, Create and Share. Simply with <span className="font-extrabold bg-amber-200 p-1 lg:p-2 rounded-xl">DoodleArt</span>
        </p>
        ...
        <div className="px-6 md:px-8 lg:px-12">
          ...
          <div className="flex flex-col lg:flex-row gap-6 text-black justify-around">
            ...
            {/* Card 2 */}
            <Card img="multiplayer.svg" alt="multiplayer" title="Multiple Users Editing">
