                        ...
                        <div className="flex flex-col gap-2 w-full items-center">
                            ...
                            <div className="relative w-full">
                                <span className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-400">
                                    <Image src='/username.svg' alt='username' width={23} height={23} draggable='false' />
                                </span>
                                <input
                            ...
                            <div className="relative w-full">
                                ...
                                <input className="w-full p-3 pl-10 pr-10 bg-[#0a0a19] rounded-lg text-white"
                                    name="password"
...
// user001@gmail.com password - User@0001$